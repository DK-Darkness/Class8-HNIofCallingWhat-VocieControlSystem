...
def thread_water():
    while True:
        if boolWaterlight == 1:
            pixels.show_num(0, [255,0,0])
            time.sleep(0.2)
            pixels.show_num(1, [0,0,255])
            time.sleep(0.2)
            pixels.show_num(2, [255,0,255])
            time.sleep(0.2)
            pixels.show_num(3, [255,255,0])
            time.sleep(0.2)
            pixels.show_num(4, [255,0,255])
            time.sleep(0.2)
            pixels.show_num(5, [0,255,255])
            time.sleep(0.2)
            pixels.show_num(6, [127,0,34])
            time.sleep(0.2)
            pixels.show_num(7, [23,244,0])
            time.sleep(0.2)
            pixels.show_num(8, [0,34,244])
            time.sleep(0.2)
            pixels.show_num(9, [78,0,100])
            time.sleep(0.2)
            pixels.show_num(10, [255,32,0])
            time.sleep(0.2)
            pixels.show_num(11, [0,244,100])
            time.sleep(0.2)
        else:
            time.sleep(1)
